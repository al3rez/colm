...
typedef enum {
  ...
  GHOSTTY_ACTION_JUMP_UNREAD,
  GHOSTTY_ACTION_MARK_OLDEST_UNREAD,
  GHOSTTY_ACTION_RESTORE_PREVIOUS_SESSION,
  GHOSTTY_ACTION_NEW_EMPTY_GROUP,
  GHOSTTY_ACTION_GROUP_SELECTION,
