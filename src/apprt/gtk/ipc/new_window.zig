...
//
// ```
// gdbus call --session --dest io.github.al3rez.Colm --object-path /io/github/al3rez/Colm --method org.gtk.Actions.Activate new-window [] []
// ```
//
// `ghostty +new-window -e echo hello` would be equivalent to the following command (on a release build):
//
// ```
// gdbus call --session --dest io.github.al3rez.Colm --object-path /io/github/al3rez/Colm --method org.gtk.Actions.Activate new-window-command '[<@as ["-e" "echo" "hello"]>]' []
// ```
